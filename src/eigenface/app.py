...
from eigenface.dataset import load_dataset

# pylint: disable=invalid-name


if __name__ == "__main__":
    folder_path = str(Path(__file__).resolve().parent / "data")
    heigth, width = 64, 64
    k = 20
    iterations = 10
    tolerance = 1e-4
    ...
    mean, eigenvalues, eigenfaces, train_weights = train_eigenfaces(
        training_matrix, k, iterations, tolerance)
